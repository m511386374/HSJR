...
public class PasswordEditText extends EditText implements
    ...
    private void init() {
        ...
        if (mShowDrawable == null) {
            mShowDrawable = getResources().getDrawable(R.drawable.ic_pswd_visible);
            mHideDrawable = getResources().getDrawable(R.drawable.ic_pswd_invisible);


        }

        mShowDrawable.setBounds(0, 0, 50, 50);
        mHideDrawable.setBounds(0, 0, 50, 50);
