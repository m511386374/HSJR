package com.haosencredit.Haosenfinance.view.progressbar;
...
public class MyHoriztalProgressBar extends ProgressBar {
    ...
    private final int PROGRESSBAR_DEFAULT_HEIGHT = dp2px(6);//px
    private final int PROGRESSBAR_DEFAULT_REACH_COLOR = 0xfffe7e3f;
    private final int PROGRESSBAR_DEFAULT_UNREACH_COLOR = 0xFFDEDEDE;
