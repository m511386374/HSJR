package com.haosencredit.Haosenfinance.view.loop;
...
public class CircleIndicator extends LinearLayout {
    ...
    private LoopViewPager2 mViewpager;
    ...
    public void setViewPager(LoopViewPager2 viewPager) {
...
//            mViewpager.addOnPageChangeListener(mInternalPageChangeListener);
    ...
    private final LoopViewPager2.OnPageChangeListener mInternalPageChangeListener = new LoopViewPager2.OnPageChangeListener() {
     ...
     */
    @Deprecated public void setOnPageChangeListener(LoopViewPager2.OnPageChangeListener onPageChangeListener) {
        if (mViewpager == null) {
