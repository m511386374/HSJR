...
import com.haosencredit.Haosenfinance.adapter.GuideViewPagerAdapter;
 ...
 */
@Route(path = "/Hsjr/WelcomeGuideActivity")
public class WelcomeGuideActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarCompat.translucentStatusBar(WelcomeGuideActivity.this);
    ...
    protected void onPause() {
        ...
        SPUtils.put(WelcomeGuideActivity.this, Constans.FIRST_OPEN, false);
        finish();
    }
...
//        Intent a =new Intent(WelcomeGuideActivity.this,WelcomeActivity.class);
//        startActivity(a);
        ARouter.getInstance()
                .build("/Hsjr/WelcomeActivity")
                .navigation();
//
        SPUtils.put(WelcomeGuideActivity.this, Constans.FIRST_OPEN, false);
       finish();
